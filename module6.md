...
In this module, students will learn to use StoryScapes as a platform to support project that are larger than what they can implement alone, including Community Initiatives, Organization Accounts and Open-Source Feature Enhancements.
...
A Community Initiative is an effort by a group of StoryScapes users to collect StoryLayer data and compose StoryScapes around a common theme.
...
Community Initiatives are hosted on a special account page inside StoryScapes. They can be accessed by going to the StoryScapes Explore page and filtering for Teams.
...
StoryScapes users can also request to become Members of your Community Initiative. This is simply a way for you to indicate people that are supportive of your Community Initiative and helping with the work in some way. A user can request to become a Member. You can accept or reject these requests from the management page for the Community Initiative.

![SCREENSHOT](figures/Twopartsofthegeospatialdatamodel.png "Two parts of the geospatial data model")

### Demonstration

Now that you've learned how to manage a Community Initiative, let's watch an example of a user performing these actions:
...
- [x] Second, log off from your current account and log back on to StoryScapes using this test account - XXXX XXXX. This account is an Organizer for the XXXX Community Initiative. Go to this Community Initiative and make one improvement to the profile.
- [x] Third, add at least one StoryLayer or StoryScape to the XXXX Community Initiative.
- [x] Finally, do you have an idea for a Community Initiative? If so, send an email to XXXX. Maybe after you complete this course, the idea will become a reality!

## Lesson 2: Managing Organization Accounts
##### Objective
In this lesson, students will learn how to manage an Organization Account in StoryScapes.

### Lecture
Organization Accounts are very similar in structure to Community Initiative pages, although they have slightly different purposes. Community Initiatives are designed to promote collaboration around a single thematic content area that is pertinent for a period of time. Organization Accounts are designed for work units like agencies, teams, offices, departments and companies that benefit from a single place to represent their collective work on StoryScapes. For example, a regional desk inside the State Department may manage an Organization Account to host all of the StoryLayers and StoryScapes it produces over time.
...
StoryScapes users can also request to become Members of your Organization. This is simply a way for you to indicate people that are involved in your Organization.
...
- [x] Second, log off from your current account and log back on to StoryScapes using this test account - XXXX XXXX. This account is an Organizer for the XXXX Organization Account Go to this Organization page and make one improvement to the profile.
- [x] Third, add at least one StoryLayer or StoryScape to the XXXX Organization Account.
- [x] Finally, do you have an idea for an Organization Account? If so, send an email to XXXX. Maybe after you complete this course, the idea will become a reality!
...
StoryScapes users also have an opportunity to help improve the platform itself. If you have an interest or ability to go above and beyond to help StoryScapes improve, consider the following four actions:

###### Report Issues

As you use the StoryScapes platform, you can report any issues you experience. XXXX
...
In this Module you have learned how you can use StoryScapes to bring people together, whether its bringing users together around a common interest in the form of a Community Initiative, or its bringing users together that work on the same time through an Organization Account.
